<?php
/**
 * Template Name: Equipment - JLG 1055
 *
 * Assign this template to a child page under "Equipment" with the slug
 * "jlg-1055" — see WP-INSTALL.md for the full one-time setup.
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
}
$denson_cel_meta_description = 'Rent the JLG 1055 telehandler from Denson Commercial Equipment Leasing — 10,000 lb capacity, 55 ft lift height, inspected and jobsite-ready.';
get_header();
?>

  <div class="page-header">
    <div class="container">
      <p class="breadcrumb"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a> / <a href="<?php echo esc_url( home_url( '/equipment/' ) ); ?>">Equipment</a> / JLG 1055</p>
      <p class="eyebrow">Telehandler</p>
      <h1 class="display-1">JLG 1055</h1>
    </div>
  </div>
    ...
    <div class="container">
      <div class="unit-hero">
        ...
        <div data-reveal>
          ...
          <p class="body-text mt-3">Denson runs every 1055 through a full inspection and maintenance pass before it leaves the yard, so the unit that shows up on your site is ready to work its first hour on the clock, not its first hour in the shop.</p>
          <div class="tag-row">
            <span class="tag-chip">High-Reach Material Placement</span>
            <span class="tag-chip">Steel & Truss Setting</span>
            <span class="tag-chip">Warehouse Loading</span>
            <span class="tag-chip">Site Logistics</span>
          </div>
          <div class="mt-4">
      ...
      <div class="spec-strip" data-reveal>
        ...
        <div class="spec">
          <div class="spec__value">55 ft</div>
          <p class="spec__label">Max Lift Height</p>
        </div>
        <div class="spec">
          <div class="spec__value">~42 ft</div>
  ...
  <section class="section section--dark">
    <div class="container">
      ...
      <div class="cross-sell-grid" data-reveal>
        <?php
        foreach ( array( 'skytrak-10054', 'jlg-660sj' ) as $denson_cel_cross_slug ) {
  ...
  <div class="sticky-cta-bar">
    <span class="sticky-cta-bar__label">JLG 1055</span>
    <a class="btn btn-primary" href="<?php echo esc_url( denson_cel_rent_url() ); ?>" target="_blank" rel="noopener">Rent Equipment</a>
  </div>
